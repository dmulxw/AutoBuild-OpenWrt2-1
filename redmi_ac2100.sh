...
# 3. Add ntripclient and ntripserver to default packages
echo "CONFIG_PACKAGE_ntripclient=y" >> openwrt/.config
echo "CONFIG_PACKAGE_ntripserver=y" >> openwrt/.config

# 4. Configure Ntrip services
...
# 7. Create Luci interface for Ntrip settings
